...
[_BASE] = LAYOUT_all(
	...
	KC_LCTL, KC_LGUI, KC_LALT,    LT(_UNI,KC_SPC),    MO(_UNI), MO(_ADV), KC_RCTL
),
...
[_ADV] = LAYOUT_all(
	...
	KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_NO, KC_INS, KC_DEL, KC_TRNS, KC_NO,
	KC_TRNS, KC_WWW_HOME, KC_TRNS,    KC_TRNS,    KC_NO, KC_NO, KC_CALC
),

[_FN] = LAYOUT_all(
	KC_NO, H1_DEC, H1_INC, S1_DEC, S1_INC, H2_DEC, H2_INC, S2_DEC, S2_INC, EF_DEC, EF_INC, BR_DEC, BR_INC, KC_NO, KC_NO,
...
[_UNI] = LAYOUT_all(
	KC_NO, KC_NO, KC_NO, KC_NO, UC(L'§'), KC_NO, UC(L'°'), KC_NO, KC_NO, KC_NO, KC_NO, UC(L'–'), KC_NO, KC_NO, KC_NO,
	...
	MO(_UNI2), KC_NO, UC(L'×'), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, UC(L'•'), UC(L'…'), KC_NO, MO(_UNI2), KC_NO,
	KC_NO, KC_NO, KC_NO,    KC_TRNS,    KC_NO, KC_NO, UC_MOD
),

...
[_BASE] = LAYOUT_all(
	...
	KC_LCTL, KC_LGUI, KC_LALT,    LT(_UNI,KC_SPC),    MO(_ADV), MO(_UNI), KC_RCTL
),
...
[_ADV] = LAYOUT_all(
	...
	KC_TRNS, KC_NO, KC_TRNS,    KC_TRNS,    KC_NO, KC_NO, KC_NO
),
...
[_UNI] = LAYOUT_all(
	...
	MO(_UNI2), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, UC(L'…'), KC_NO, MO(_UNI2), KC_NO,
